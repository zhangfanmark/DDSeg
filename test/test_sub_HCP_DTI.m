...
DTI_ouput_folder  = 'test/test_sub_HCP/DTI';
...
out_nii_file    = 'test/test_sub_HCP/DTI/HCP-100337-b1000.nii.gz';
out_bval_file   = 'test/test_sub_HCP/DTI/HCP-100337-b1000.bval';
out_bvec_file   = 'test/test_sub_HCP/DTI/HCP-100337-b1000.bvec';

removed_bvals = [10:999,1001:4000];
...
parameter_type           = 'DTI';
output_folder            = 'test/test_sub_HCP/DTISeg';
